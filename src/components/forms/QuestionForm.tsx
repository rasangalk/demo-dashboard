...
export function QuestionForm({
  ...
  useEffect(() => {
    if (initialSelection) {
      ...
      // If form values are still empty (e.g., on edit mount), set them.
      if (!form.getValues('subjectId')) {
        form.setValue('subjectId', initialSelection.subjectId);
      }
